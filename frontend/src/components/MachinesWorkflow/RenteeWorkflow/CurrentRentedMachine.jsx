...
function CurrentRentedMachine({ machineId }) {
    ...
    return (
        <div className='MachineDetails'>
            ...
            <div className='remainingRentalTime'>
                <p>Remaining Rental Time : </p>
            </div>
            <div className='mRatings'>
                <p>Machine Ratings: 0⭐</p>
            </div>
            <button onClick={handleRemoveMachine}>Rentee Details</button>
...
export default CurrentRentedMachine;
